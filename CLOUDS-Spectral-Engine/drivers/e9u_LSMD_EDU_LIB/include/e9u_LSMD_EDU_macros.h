...
DLL_API int DLL_CALL e9u_LSMD_EDU_search_for_camera (unsigned int ui_camera_index, int i_USB);
DLL_API int DLL_CALL e9u_LSMD_EDU_start_camera_async (unsigned int ui_camera_index);
DLL_API int DLL_CALL e9u_LSMD_EDU_set_exp_time (unsigned int ui_camera_index, double d_exp_time);
DLL_API int DLL_CALL e9u_LSMD_EDU_set_exp_time_us (unsigned int ui_camera_index, unsigned int ui_exp_time);
DLL_API int DLL_CALL e9u_LSMD_EDU_get_next_frame (unsigned int ui_camera_index);
